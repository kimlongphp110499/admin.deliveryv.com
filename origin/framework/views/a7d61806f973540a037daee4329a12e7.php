...
} elseif ($_instance->childHasBeenRendered('l3693762136-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3693762136-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3693762136-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3693762136-0');
} else {
    $response = \Livewire\Livewire::mount('header.vendor-selector');
    $html = $response->html();
    $_instance->logRenderedChild('l3693762136-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <?php endif; ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/header/profile.blade.php ENDPATH**/ ?>