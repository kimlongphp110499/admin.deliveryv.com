...
} elseif ($_instance->childHasBeenRendered('l3406546038-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3406546038-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3406546038-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3406546038-0');
} else {
    $response = \Livewire\Livewire::mount('settings.privacy-policy', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3406546038-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l3406546038-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3406546038-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3406546038-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3406546038-1');
} else {
    $response = \Livewire\Livewire::mount('settings.contact', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3406546038-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l3406546038-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3406546038-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3406546038-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3406546038-2');
} else {
    $response = \Livewire\Livewire::mount('settings.terms', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3406546038-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l3406546038-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3406546038-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3406546038-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3406546038-3');
} else {
    $response = \Livewire\Livewire::mount('settings.order-reasons', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3406546038-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/settings/pages.blade.php ENDPATH**/ ?>