...
} elseif ($_instance->childHasBeenRendered('l34449992-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l34449992-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l34449992-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l34449992-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l34449992-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
    ...
    <?php else: ?>
        ...
        <div class="w-full p-12 mx-auto my-12 rounded-sm shadow md:w-5/12 lg:w-4/12 ">
            ...
            <p class='mt-4 text-center'><a href="<?php echo e(route('contact')); ?>"
                    class="underline text-primary-600"><?php echo e(__('Contact Us')); ?></a></p>
        </div>
    <?php endif; ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/auth/register/driver_register.blade.php ENDPATH**/ ?>