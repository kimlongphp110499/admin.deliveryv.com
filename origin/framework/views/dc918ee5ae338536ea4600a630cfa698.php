                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="env_key" class="col-form-label"><?php echo e(__($translatePrefix.'modal.input.key')); ?>:</label>
                            <input type="text" class="form-control" id="env_key" :readonly="readonly.key" v-model.trim="modalItem.key"/>
                        </div>
                        <div class="form-group">
                            <label for="env_value" class="col-form-label"><?php echo e(__($translatePrefix.'modal.input.value')); ?>:</label>
                            <input type="text" class="form-control" id="env_value" :readonly="readonly.value" v-model.trim="modalItem.value"/>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="hideModal()"><?php echo e(__($translatePrefix.'modal.btn.close')); ?></button>
    ...
    <script>
        ...
        let itemsModal = {
            ...
            computed: {
                submitBtn() {
                    let values = {
                        'new': '<?php echo e(__($translatePrefix."modal.btn.new")); ?>',
                        'edit': '<?php echo e(__($translatePrefix."modal.btn.edit")); ?>',
                        'delete': '<?php echo e(__($translatePrefix."modal.btn.delete")); ?>',
                    };
                ...
                title() {
                    let values = {
                        'new': '<?php echo e(__($translatePrefix."modal.title.new")); ?>',
                        'edit': '<?php echo e(__($translatePrefix."modal.title.edit")); ?>',
                        'delete': '<?php echo e(__($translatePrefix."modal.title.delete")); ?>',
                    };
            ...
            methods: {
                ...
                submit() {
                    envClient('<?php echo e(route(config($package.'.route.name').'.key')); ?>',{
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/vendor/geo-sot/laravel-env-editor/src/../resources/views/components/_itemModal.blade.php ENDPATH**/ ?>