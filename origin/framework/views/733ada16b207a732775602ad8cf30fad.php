        ...
        <div id="uploadEnvForm">
            <div class="input-group  mb-4">
                ...
                <div class="input-group-append" v-if="hasFile">
                    <button class="btn btn-outline-secondary" @click="clearFileInput" type="button"><?php echo e(__($translatePrefix.'btn.clearFile')); ?></button>
                </div>
            </div>
            <div class="my-4">
                <button class="btn-info btn " :disabled="!hasFile" @click="uploadAsBackUp"><?php echo e(__($translatePrefix.'btn.uploadAsBackup')); ?></button>
                <button class="btn-warning btn " :disabled="!hasFile" @click="uploadAndReplaceCurrent"><?php echo e(__($translatePrefix.'btn.uploadAndReplace')); ?></button>
            </div>
        </div>
    </div>
</template>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        const fileUpload = {
            ...
            computed: {
                promptMsg() {
                    return this.hasFile ? this.fileName : "<?php echo e(__($translatePrefix.'selectFilePrompt')); ?>"
                },
                hasFile() {
            ...
            methods: {
                ...
                submitForm(event, replaceCurrentEnv = false) {
                    ...
                    envClient('<?php echo e(route(config($package.'.route.name').'.upload')); ?>', {
                        body: formData,
                        method: 'post',
                    }).then(data => {
                        if (data.message) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/vendor/geo-sot/laravel-env-editor/src/../resources/views/components/_upload.blade.php ENDPATH**/ ?>