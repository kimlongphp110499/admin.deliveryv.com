...
} elseif ($_instance->childHasBeenRendered('l1399220213-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1399220213-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1399220213-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1399220213-0');
} else {
    $response = \Livewire\Livewire::mount('tables.tag-link-table', ['model' => $selectedModel]);
    $html = $response->html();
    $_instance->logRenderedChild('l1399220213-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/tag_link.blade.php ENDPATH**/ ?>