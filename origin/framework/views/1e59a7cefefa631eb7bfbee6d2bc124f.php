...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Roles')).'','showNew' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Roles')).'','showNew' => true]); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('tables.role-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l1340055492-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1340055492-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1340055492-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1340055492-0');
} else {
    $response = \Livewire\Livewire::mount('tables.role-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1340055492-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Update')).'','action' => 'update']); ?>
            <p class="text-xl font-semibold"><?php echo e(__('Edit')); ?> <?php echo e($selectedModel->name ?? ''); ?> <?php echo e(__('Permissions')); ?></p>
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
                <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if (isset($component)) { $__componentOriginal74b62b190a03153f11871f645315f4de = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74b62b190a03153f11871f645315f4de = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.checkbox','data' => ['title' => ''.e($permission->name).'','name' => 'selectedPermissions.'.e($permission->id).'','value' => ''.e($permission->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($permission->name).'','name' => 'selectedPermissions.'.e($permission->id).'','value' => ''.e($permission->name).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Save')).'','action' => 'save']); ?>
            <p class="text-xl font-semibold"><?php echo e(__('New Role')); ?></p>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/settings/roles.blade.php ENDPATH**/ ?>