...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginalf6e2e415902e89bd5e110fa89659d933 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf6e2e415902e89bd5e110fa89659d933 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.details.item','data' => ['title' => ''.e(__('Collect Payment From')).'','text' => ''.e($selectedModel->payer ?? 1 ? __('Sender') : 'Receiver').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Collect Payment From')).'','text' => ''.e($selectedModel->payer ?? 1 ? __('Sender') : 'Receiver').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf6e2e415902e89bd5e110fa89659d933)): ?>
<?php $attributes = $__attributesOriginalf6e2e415902e89bd5e110fa89659d933; ?>
...
<?php $__currentLoopData = $selectedModel->stops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="grid grid-cols-1 gap-4 px-2 my-1 border border-gray-300 rounded-md md:grid-cols-2">
        <?php if (isset($component)) { $__componentOriginalf6e2e415902e89bd5e110fa89659d933 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf6e2e415902e89bd5e110fa89659d933 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.details.item','data' => ['title' => ''.e(__('Stop')).' '.e($key + 1).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component->withAttributes(['title' => ''.e(__('Note')).'']); ?>
            <p class="break-words overflow-clip"> <?php echo e($stop->note ?? ''); ?></p>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf6e2e415902e89bd5e110fa89659d933)): ?>
<?php $attributes = $__attributesOriginalf6e2e415902e89bd5e110fa89659d933; ?>
...
<?php endif; ?>
        ...
        <?php if($stop != null && $stop->proof && !strpos($stop->proof, 'default.png')): ?>
            <?php if (isset($component)) { $__componentOriginalf6e2e415902e89bd5e110fa89659d933 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf6e2e415902e89bd5e110fa89659d933 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.details.item','data' => ['title' => ''.e(__('Order Stop Proof')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Order Stop Proof')).'']); ?>
                <a href="<?php echo e($stop->proof); ?>" target="_blank"> <img src="<?php echo e($stop->proof); ?>"
...
<?php if($selectedModel != null && $selectedModel->photo && !strpos($selectedModel->photo, 'default.png')): ?>
    <p class="mt-8 font-bold text-md"><?php echo e(__('Order Photo')); ?></p>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/order/package_order_details.blade.php ENDPATH**/ ?>