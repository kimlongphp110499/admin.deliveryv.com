<?php $__env->startSection('title', __('Car Makes') ); ?>
<div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Car Makes')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Car Makes')).'']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('tables.taxi.car-make-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l235030198-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l235030198-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l235030198-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l235030198-0');
} else {
    $response = \Livewire\Livewire::mount('tables.taxi.car-make-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l235030198-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('New')).'','action' => 'save','clickAway' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
            <p class="text-xl font-semibold"><?php echo e(__('New Car Make')); ?></p>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/taxi/car_makes.blade.php ENDPATH**/ ?>