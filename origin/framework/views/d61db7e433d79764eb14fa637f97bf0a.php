...
} elseif ($_instance->childHasBeenRendered('l1275891326-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1275891326-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1275891326-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1275891326-0');
} else {
    $response = \Livewire\Livewire::mount('livewire-pie-chart', ['pieChartModel' => $servicesChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l1275891326-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1275891326-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1275891326-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1275891326-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1275891326-1');
} else {
    $response = \Livewire\Livewire::mount('livewire-pie-chart', ['pieChartModel' => $topCategoriesChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l1275891326-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
             <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalf492f551685e3ce8be093bf80555c952 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf492f551685e3ce8be093bf80555c952 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Services Report')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('baseview'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
} elseif ($_instance->childHasBeenRendered('l1275891326-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1275891326-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1275891326-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1275891326-2');
} else {
    $response = \Livewire\Livewire::mount('tables.reports.service-report-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1275891326-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/reports/services_report.blade.php ENDPATH**/ ?>