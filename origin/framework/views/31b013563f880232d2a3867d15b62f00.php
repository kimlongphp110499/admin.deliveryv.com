            ...
            <form wire:submit.prevent="<?php echo e($action ?? ''); ?>">
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button"
                        ...
                        <?php if($onCancel ?? false): ?> wire:click="<?php echo e($onCancel); ?>"
            <?php else: ?>
            wire:click="$emitUp('dismissModal')" <?php endif; ?>>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/components/modal-xl.blade.php ENDPATH**/ ?>