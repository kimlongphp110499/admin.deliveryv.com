...
} elseif ($_instance->childHasBeenRendered('l2547409339-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2547409339-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2547409339-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2547409339-0');
} else {
    $response = \Livewire\Livewire::mount('tables.service-option-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2547409339-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l2547409339-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2547409339-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2547409339-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2547409339-1');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l2547409339-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
             <?php echo $__env->renderComponent(); ?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('select.multiple-service-select', ['name' => 'service_id','placeholder' => ''.e(__('Search services')).'','multiple' => true,'searchable' => true])->html();
} elseif ($_instance->childHasBeenRendered('l2547409339-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2547409339-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2547409339-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2547409339-2');
} else {
    $response = \Livewire\Livewire::mount('select.multiple-service-select', ['name' => 'service_id','placeholder' => ''.e(__('Search services')).'','multiple' => true,'searchable' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l2547409339-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
             <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/service-options.blade.php ENDPATH**/ ?>