...
} elseif ($_instance->childHasBeenRendered('l1279610667-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1279610667-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1279610667-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1279610667-0');
} else {
    $response = \Livewire\Livewire::mount('tables.delivery-zone-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1279610667-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['title' => ''.e(__('Delivery Fee')).'','name' => 'delivery_fee','hint' => ''.e(__('Leave empty if you do not want to set delivery fee')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Delivery Fee')).'','name' => 'delivery_fee','hint' => ''.e(__('Leave empty if you do not want to set delivery fee')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php $__env->startPush('scripts'); ?>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(setting('googleMapKey', '')); ?>&callback=initMap&libraries=drawing&v=weekly"
        async></script>
    <script src="<?php echo e(asset('js/delivery-zone.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/delivery_zones.blade.php ENDPATH**/ ?>