...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Menu')).'','showNew' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Menu')).'','showNew' => true]); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('tables.menu-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l453296062-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l453296062-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l453296062-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l453296062-0');
} else {
    $response = \Livewire\Livewire::mount('tables.menu-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l453296062-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.details.item','data' => ['title' => ''.e(__('Vendor')).'','text' => ''.e(\Auth::user()->vendor->name ?? '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Vendor')).'','text' => ''.e(\Auth::user()->vendor->name ?? '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['options' => $vendors ?? [],'name' => 'vendor_id','title' => ''.e(__('Vendor')).'','noPreSelect' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($vendors ?? []),'name' => 'vendor_id','title' => ''.e(__('Vendor')).'','noPreSelect' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/menu.blade.php ENDPATH**/ ?>