<?php $__env->startSection('title', __('Product Requests')); ?>
<div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Product Requests')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Product Requests')).'']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('tables.product-request-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l2939287370-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2939287370-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2939287370-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2939287370-0');
} else {
    $response = \Livewire\Livewire::mount('tables.product-request-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2939287370-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/deliveryv/public_html/admin.deliveryv.com/resources/views/livewire/product_requests.blade.php ENDPATH**/ ?>